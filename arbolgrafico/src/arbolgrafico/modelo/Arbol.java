...
public class Arbol {
    ...
    //Recoge el dato y lo inserta en la raiz
    ...
    /**
     * 
     * @param nuevo parametro que indica que se agrega un nuevo nodo o nuevo dato al arbol
     * @param pivote parametro que funciona como apuntador de cada hijo
     */
    public void insertar(Nodo nuevo, Nodo pivote) {
        // Si la raiz no contiene nada insertar dato 
        if (this.raiz == null) {
            raiz = nuevo;
            // si ya hay un dato en la raíz
        } else {
            //Si el dato es menor que el dato que ya se encuentra dentro del arbol, insertar el nuevo 
            //dato a la izquierda
            if (nuevo.getDato() <= pivote.getDato()) {
                ...
                //si el dato es mayor entonces lo inserta en la derecha
            } else {
    ...
    /**
     * 
     * @param reco parametro que le indica al nodo por donde debe pasar, el recorrido que va a hacer
     */
